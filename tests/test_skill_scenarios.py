...
from sentientagent_v2.skills import read_skill
from sentientagent_v2.tools import read_file, web_fetch, write_file
...
"""
    ...
    def test_weihai_weather_fetch(self) -> None:
        ...
        with patch("sentientagent_v2.tools.urlopen", return_value=_FakeResponse()):
            data = json.loads(
                web_fetch(
